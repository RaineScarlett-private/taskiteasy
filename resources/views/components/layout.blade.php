    ...
    <div class="container">
        ...
        <div class="navbar-menu" id="navMenu">
            <div class="navbar-start">
                <a href="/" class="navbar-item is-inactive">Home</a>
                <a href="/about" class="navbar-item is-inactive">About</a>
                <a href="{{ route('posts.index') }}" class="navbar-item is-inactive">Posts</a>
            </div>
        </div>
    </div>
</nav>
